...
\newglossaryentry{System-Administrator}{
    ...
    plural=System-Administratoren,
    description={Eine Person, die die Ausführungsumgebung des Systems verwaltet. Unter anderem verantwortlich für das Starten und Beenden des Systems}
}
...
\newglossaryentry{Mallob}{
    name=Mallob,
    description={Mallob ist ein dezentrales System zum Scheduling und Lösen von NP-schweren Problemen, hauptsächlich entwickelt von Dominik Schreiber im Rahmen seiner Doktorarbeit. Das Projekt ist \href{https://github.com/domschrei/mallob}{hier} zu finden. \textit{Fallob} stellt ein nutzerfreundliches Interface zu Mallob dar}}