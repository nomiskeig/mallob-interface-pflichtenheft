...
\section{Zielbestimmung}
\textit{Fallob} ermöglicht es \glslink{Nutzer}{Nutzern}, einfacher mit \href{https://github.com/domschrei/\gls{Mallob}}{\gls{Mallob}} zu interagieren. Diese Interaktion kann auf zwei Wege erfolgen:
...
\subsection{Wunschkriterien}
    \begin{itemize}[noitemsep]
        ...
        \item Möglichkeit für \glslink{Administrator}{Administratoren}, \gls{Mallob} zu starten, beenden oder neuzustarten \hyperref[FA:Web-Interface:Verwalten von Malllob]{(F2140)}
