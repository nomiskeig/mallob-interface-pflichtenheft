...
\begin{itemize}
    ...
    \textbf{Beschreibung:}
    \begin{FAList} 
        \item[1.] Aufrufen des \gls{Web-Interface}s.
   ...
   % \end{FAList}
    ...
    \begin{FAList}
        \item[1.] Die Tabelle wird automatisch aktuell gehalten, die  entsprechende Schaltfläche entfällt.
    \end{FAList}
...
\phantomsection
    ...
    \textbf{Beschreibung:}
    \begin{FAList} 
        \item[1.] Anzeigen eines Eintrags für Plugins in der Navigations-Leiste, welcher es ermöglicht, die \hyperref[pages:plugin]{Seiten der Plugins} aufzurufen.
    \end{FAList}
...
\begin{itemize}
    ...
    \begin{FAList} 
        ...
        \item[2.a.] Wenn die \hyperref[pages:visualization]{Visualisierung} erfolgreich geladen wurde, wird diese im \gls{Web-Interface} angezeigt. Die \hyperref[pages:visualization]{Visualisierung} wird automatisch aktualisiert, außer es wird mittels \hyperref[FA:Visualisierung:Springen]{F3040} ein vergangener Zeitpunkt angezeigt, oder die Visualisierung ist mittels \hyperref[FA:Visualisierung:Pausieren der Visualisierung]{Pausiert}
