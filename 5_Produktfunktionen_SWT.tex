...
\begin{itemize}[nosep]
    ...
    \end{FAList}
    \textbf{Alternative 3 zu den Schritten 1 und 2: (gewünscht)}
    \begin{FAList}
        \item[1] Der \gls{Nutzer} schickt eine Anfrage an die \gls{API}, die eine Referenz auf einen abgebrochenen Job enthält.
        \item[2] Der angegebene \hyperref[B:Jobs]{Job} wird neu gestartet.
    \end{FAList}
